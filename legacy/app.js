...
en: {
  ...
  about_desc1:"QuadifySoft is focused on building software that solves real business problems — not just making interfaces that look good without doing anything useful.",
  ...
  contact_desc:"If you are looking for a serious software partner for custom systems, AI tools, cloud platforms, or business automation — QuadifySoft is ready to talk.",
  ...
  form_project_type_opt0:"Select project type", form_project_type_opt1:"New build",
  form_project_type_opt2:"Upgrade", form_project_type_opt3:"Automation",
  form_timeline_l:"Timeline",
  form_timeline_opt0:"Select timeline", form_timeline_opt1:"ASAP",
  form_timeline_opt2:"1-3 months", form_timeline_opt3:"3+ months",
  form_budget_l:"Budget range",
  form_budget_opt0:"Select budget range", form_budget_opt1:"Up to €5k",
  form_budget_opt2:"€5k - €15k", form_budget_opt3:"€15k - €30k",
  form_budget_opt4:"€30k+",
  form_message_l:"Message", form_message_ph:"Tell us about your project, goals, and timeline...",
  form_success:"✓ We received your inquiry. We will contact you as soon as possible.",
  ...
  footer_rights:"© 2026 QuadifySoft. All rights reserved.",
...
sr: {
  ...
  metric_1:"Poslovni sistemi po meri", metric_2:"AI radni tokovi",
  ...
  project3_type:"Kladionica / Platforma", project3_title:"Kompletna platforma za operacije kladionice",
  ...
  about_desc1:"QuadifySoft je fokusiran na razvoj softvera koji rešava stvarne poslovne probleme — ne samo na interfejse koji lepo izgledaju, a ne rade ništa korisno.",
  ...
  contact_desc:"Ako tražite ozbiljnog softverskog partnera za custom sisteme, AI alate, cloud platforme ili automatizaciju poslovanja — QuadifySoft je spreman za razgovor.",
  contact_note:"Otvoreni smo za razgovore o projektima i dugoročnoj saradnji.",
  contact_btn:"Pošalji poruku",
  form_name_l:"Ime", form_name_ph:"Vaše ime",
  ...
  form_project_type_opt0:"Izaberite tip projekta", form_project_type_opt1:"Novi sistem",
  form_project_type_opt2:"Nadogradnja", form_project_type_opt3:"Automatizacija",
  form_timeline_l:"Rok",
  form_timeline_opt0:"Izaberite rok", form_timeline_opt1:"ASAP",
  form_timeline_opt2:"1-3 meseca", form_timeline_opt3:"3+ meseca",
  form_budget_l:"Budžet",
  form_budget_opt0:"Izaberite budžet", form_budget_opt1:"Do €5k",
  form_budget_opt2:"€5k - €15k", form_budget_opt3:"€15k - €30k",
  form_budget_opt4:"€30k+",
  ...
  footer_rights:"© 2026 QuadifySoft. Sva prava zadržana.",
...
async function handleSubmit(e) {
  ...
  const payload = {
    ...
    project_type: form.querySelector('#contactProjectType').value,
    timeline: form.querySelector('#contactTimeline').value,
    budget: form.querySelector('#contactBudget').value,
    message: form.querySelector('#contactMessage').value.trim(),
    _subject: 'New project inquiry - QuadifySoft',
    _autoresponse: 'Primili smo vas upit. Hvala na poverenju - javicemo vam se u najkracem roku.',
    _template: 'table',
    _captcha: 'false'
  };

  if (!payload.name || !payload.email || !payload.service || !payload.project_type || !payload.timeline || !payload.budget || !payload.message) return;
  ...
  try {
    const response = await fetch('https://formsubmit.co/ajax/quadifysoft@gmail.com', {
      method: 'POST',
...
window.addEventListener('load', () => {
  ...
  const lang = (qsLang === 'en' || qsLang === 'sr') ? qsLang : (localStorage.getItem('qs_lang') || 'sr');
  setLang(lang);
  initMobileNav();
  initMoreMenu();
  initActiveNav();
