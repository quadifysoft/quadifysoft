...
en: {
  ...
  nav_cases:"Case Studies", nav_results:"Results", nav_process:"Process", nav_engage:"Engagement", nav_why:"Why us", nav_about:"About", nav_faq:"FAQ", nav_call:"Book Call", nav_more:"More", nav_menu:"Menu", nav_open_menu:"Open menu", nav_close_menu:"Close menu", nav_contact:"Contact", nav_local:"Serbia", nav_cta:"Start",
  ...
  services_desc:"We focus on practical software solutions that improve operations, reduce manual work, and help companies scale with confidence.",
  card1_title:"Custom Business Software", card1_desc:"Internal tools, portals, admin panels, and operational systems tailored to real business processes. Built for how your team actually works.",
  ...
  results_desc:"We do not optimize for demos. We optimize for faster operations, less manual work, and higher execution quality across teams.",
  ...
  why_desc:"We do not build generic solutions just to fill screens. We build systems that help businesses move faster, operate better, and grow with less friction.",
  why1_title:"Business-first thinking", why1_desc:"Every feature must have a clear role, practical value, and business purpose. We ask why before we ask how.",
  ...
  local_label:"Local",
  local_h2:"Software Development in Serbia",
  local_desc:"Quadify Soft helps companies across Serbia and regionally build serious digital systems: web apps, custom business software, AI tools, and cloud solutions. Kraljevo remains part of our local SEO strategy.",
  local_card1_h:"Custom software for companies in Serbia",
  local_card1_p:"We build solutions tailored to real business workflows: from internal tools to complex platforms.",
  local_card2_h:"Web apps and business automation",
  local_card2_p:"From idea to production, with a focus on speed, reliability, and long-term scalability.",
  local_card3_h:"AI and cloud development in Serbia",
  local_card3_p:"We implement AI workflows and cloud infrastructure for modern teams focused on measurable results.",
  local_card4_h:"Looking for a development team in Serbia?",
  local_card4_p:"Send us your project details and we will propose a clear next-step plan.",
  local_seo_page:"Software Development Kraljevo",
  local_seo_page_web:"Web App Development Kraljevo",
  local_seo_page_custom:"Custom Software Kraljevo",
...
sr: {
  ...
  nav_cases:"Studije", nav_results:"Rezultati", nav_process:"Proces", nav_engage:"Saradnja", nav_why:"Zašto mi", nav_about:"O nama", nav_faq:"FAQ", nav_call:"Poziv", nav_more:"Više", nav_menu:"Meni", nav_open_menu:"Otvori meni", nav_close_menu:"Zatvori meni", nav_contact:"Kontakt", nav_local:"Srbija", nav_cta:"Pokreni",
  ...
  cases_desc:"Reprezentativni formati projekata koje isporučujemo. Obim i metrike zavise od kompleksnosti domena, spremnosti tima i kvaliteta podataka.",
  ...
  results_desc:"Ne optimizujemo za demo prikaz. Optimizujemo za brže operacije, manje manuelnog rada i kvalitetniju realizaciju u timovima.",
  ...
  why_desc:"Ne pravimo generička rešenja samo da bi nešto izgledalo moderno. Pravimo sisteme koji pomažu firmama da rade brže, bolje i sa manje operativnog trenja.",
  why1_title:"Fokus na biznis", why1_desc:"Svaka funkcija mora da ima jasnu ulogu, praktičnu vrednost i poslovnu svrhu. Pitamo zašto pre nego što pitamo kako.",
  ...
  faq3_q:"Da li AI funkcije mogu bezbedno u produkciju?",
  ...
  local_label:"Lokalno",
  local_h2:"Programiranje u Srbiji",
  local_desc:"Quadify Soft pomaže firmama širom Srbije i regionalno da izgrade ozbiljne digitalne sisteme: web aplikacije, poslovni softver po meri, AI alate i cloud rešenja. Kraljevo ostaje deo lokalne SEO strategije.",
  local_card1_h:"Softver po meri za firme u Srbiji",
  local_card1_p:"Razvijamo rešenja prilagođena realnim procesima poslovanja: od internih alata do kompleksnih platformi.",
  local_card2_h:"Web aplikacije i automatizacija",
  local_card2_p:"Od ideje do produkcije, uz fokus na brzinu, pouzdanost i dugoročnu skalabilnost.",
  local_card3_h:"AI i cloud razvoj u Srbiji",
  local_card3_p:"Implementiramo AI tokove i cloud infrastrukturu za moderne timove koji žele merljive rezultate.",
  local_card4_h:"Tražite tim za programiranje u Srbiji?",
  local_card4_p:"Pošaljite detalje projekta i dobićete jasan predlog narednih koraka.",
  local_seo_page:"Programiranje Kraljevo",
  local_seo_page_web:"Web aplikacije Kraljevo",
  local_seo_page_custom:"Softver po meri Kraljevo",
  ...
  call_h2:"Zakažite fokusiran konsultativni poziv",
  call_desc:"Kratak razgovor je obično dovoljan da mapiramo tok rada, postavimo prioritete i odredimo najbolji tehnički pravac.",
